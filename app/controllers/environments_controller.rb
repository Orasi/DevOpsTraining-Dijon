class EnvironmentsController < ApplicationController
  ...
  def edit
    ...
    if environment['error']
      ...
      render partial: 'environments/environment_form', locals: {environment: EnvironmentPresenter.new(environment), project_id: environment['project_id']}
    end
  end
  ...
  def create
    ...
    if environment['error']
      ...
      redirect_back fallback_location: root_path, flash: { success:  "Environment #{environment['uuid']} created"}
    end
  end
  ...
  def update
    ...
    if environment['error']
      ...
      redirect_back fallback_location: root_path, flash: { success:  "Environment #{environment['uuid']} updated"}
    end
  end
